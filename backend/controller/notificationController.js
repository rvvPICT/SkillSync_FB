...
//         const responder = await User.findById(userIdToUpdate).select('username');
//         const responseNotification = new Notification({
//             type: 'response',
//             sender: userIdToUpdate, // the one who responded
//             receiver: notification.sender, // the original sender
//             project: notification.project,
//             message: `${responder.username} has ${status} your ${notification.type}`
//         });
//         await responseNotification.save();
//         global.io.to(notification.sender.toString()).emit('new-notification', responseNotification);
...
//         console.log("Emitting notification to sender:", notification.sender);
//         emitNotification(notification.sender.toString(), 'new-notification', responseNotification);
